...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="section ambient-section overflow-hidden bg-slate-950 text-white">
      <div className="contact-aurora absolute" aria-hidden="true">
        <span />
        <span />
        <span />
      </div>
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.88fr_1.12fr] lg:px-8">
        <Reveal variant="slide">
          <aside className="lg:sticky lg:top-28">
            <p className="eyebrow-chip contact-chip">
            ...
            <AnimatedWords
              ...
              className="mt-7 max-w-xl text-4xl font-semibold leading-[1.05] tracking-tight text-white sm:text-5xl"
            />
              ...
              {[
                ...
                return (
                  <motion.a
                    ...
                    className="group flex items-center justify-between gap-4 rounded-2xl border border-white/10 bg-white/[0.04] p-4 text-slate-200 transition-colors hover:border-emerald-300/40 hover:bg-white/[0.07] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-300"
                  >
                    <span className="flex min-w-0 items-center gap-3">
                      <span className="flex h-8 w-8 flex-none items-center justify-center rounded-xl bg-emerald-400/10 transition duration-300 group-hover:scale-110 group-hover:bg-emerald-400/20">
                        <Icon className="h-4 w-4 text-emerald-300" aria-hidden="true" />
                      </span>
                      <span className="truncate">{item.label}</span>
                    </span>
                    <ArrowUpRight
                      className="h-4 w-4 flex-none text-slate-500 transition duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-emerald-300"
                      aria-hidden="true"
                    />
                  </motion.a>
                );
        ...
        <Reveal variant="right" delay={0.08}>
          <div className="contact-form-frame">
            <div className="relative rounded-[1.55rem] bg-white p-4 text-slate-950 sm:p-6">
              ...
              <form onSubmit={handleSubmit} className="grid gap-4" noValidate={false}>
                <div className="grid gap-4 sm:grid-cols-2">
                  <label className="field-shell grid gap-2 text-sm font-semibold text-slate-800">
                    Name
                    <input name="name" type="text" required autoComplete="name" className="form-input" placeholder="Your name" />
                  </label>
                  <label className="field-shell grid gap-2 text-sm font-semibold text-slate-800">
                    Email
                    <input
                ...
                <Magnetic className="inline-flex w-full sm:w-auto" strength={0.12}>
                  <button
                    ...
                    className="btn-dark group inline-flex w-full items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-semibold transition hover:-translate-y-0.5 active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto"
                  >
                    {status === "sending" ? (
                      <>
                        Sending
