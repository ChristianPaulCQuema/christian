          ...
          {services.map((service, index) => {
            ...
            return (
              <Reveal key={service.title} delay={index * 0.04} variant={index % 2 === 0 ? "mask" : "blur"}>
                <article className="interactive-card premium-surface group relative h-full overflow-hidden rounded-[1.35rem] p-5 transition duration-300 hover:-translate-y-1">
                  <div
                  ...
                  <div className="flex items-start justify-between gap-5">
                    <div className="icon-tile flex h-11 w-11 items-center justify-center rounded-xl transition duration-300 group-hover:-translate-y-1">
